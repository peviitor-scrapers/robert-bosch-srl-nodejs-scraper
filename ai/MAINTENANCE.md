...
```bash
gh issue list --repo peviitor-scrapers/robert-bosch-srl-nodejs-scraper --state open
```
...
- `docs/test-results/index.html` — branding must say "Robert Bosch", not the template's
